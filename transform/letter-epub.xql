    ...
    $input !         (
            ...
            return
                    ...
                    case element(licence) return
                        if (@target) then
                            html:link($config, ., ("tei-licence1", "licence"), 'Licence', (), (), map {"link": @target})
                        else
                    ...
                    case element(name) return
                        if (@type='person' and @ref) then
                            ...
                            if (@type='place') then
                                ...
                                html:link($config, ., ("tei-name3"), ., (), (), map {"link":                              let $ref := substring-after(./@ref, '#')                              return                                  'http://maps.google.com/maps?q=' || translate(root(.)/id($ref)/location/geo, ' ', ',')})
                            else
                    ...
                    case element(titleStmt) return
                        if ($parameters?header='short') then
                            (
                                html:link($config, ., ("tei-titleStmt3"), title[1], (), (), map {"link": $parameters?doc}),
